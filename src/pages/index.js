  ...
  return (
    ...
    <>
     ...
     <div className='pl-5 pr-5 text-center'> 
        ...
        <p className='pb-0'>I&apos;m a full stack developer making the web better at solving collective action problems.</p>
...
I soon realized that nontechnical majors were treated like second class citizens in the startup space. I decided to build a strong technical foundation that can complement my other skills.</p>
<p>Luckily, <Link href='http://www.symsyssociety.org/whatissymsys' className='underline underline-offset-2 text-cyan-700'>Stanford&#39; Symbolic Systems Program</Link> was perfect for this. I finished my masters in Symbolic Systems in 2021, focusing on artificial intelligence.</p>
...
<p className='pt-3'>Cromatic is still going on, but I&#39;ve left and am now working with a team to build infrastructure for solving collective action problems.</p>
